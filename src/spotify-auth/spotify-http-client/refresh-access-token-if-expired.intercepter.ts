...
import { requestRefreshToken } from "spotify-auth/spotify-auth-token/spotify-request-refresh-token";
 ...
 */
export function refreshAccessTokenIfExpiredInterceptor<T>(error: any, client: AxiosInstance) {
